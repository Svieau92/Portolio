...
```{r}
# Read in data set
data_cancer <- read_csv(r"(C:\Users\sviea\Downloads\lung_cancer_new_cases_per_100000_men.csv)")
...
```{r}
# Read in data set
data_gdp <- read_csv(r"(C:\Users\sviea\Documents\R for Data Science\gdp_pcap.csv)")
