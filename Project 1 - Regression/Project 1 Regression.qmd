...
![Project-1-Description]("C:/Users/sviea/Documents/Advanced Data Analysis/Advanced-Data-Analysis/Project 1 - Regression/Project 1 Description.png")
...
knitr::include_graphics("C:\\Users\\sviea\\Documents\\Advanced Data Analysis\\Project 1 MLR with Covariates\\Regression2_model_attach.png")
```
...
knitr::include_graphics("C:\\Users\\sviea\\Documents\\Advanced Data Analysis\\Project 1 MLR with Covariates\\Regression3_model_pd.png")
```
...
knitr::include_graphics("C:\\Users\\sviea\\Documents\\Advanced Data Analysis\\Project 1 MLR with Covariates\\regression imputation.png")
```
...
knitr::include_graphics("C:\\Users\\sviea\\Documents\\Advanced Data Analysis\\Project 1 MLR with Covariates\\stochastic regression imputation.png")
```
...
knitr::include_graphics("C:\\Users\\sviea\\Documents\\Advanced Data Analysis\\Project 1 MLR with Covariates\\multiple imputation.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("C:\\Users\\sviea\\Documents\\Advanced Data Analysis\\Project 1 MLR with Covariates\\rstudent-jackknife.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("C:\\Users\\sviea\\Documents\\Advanced Data Analysis\\Project 1 MLR with Covariates\\leverage_influence.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("C:\\Users\\sviea\\Documents\\Advanced Data Analysis\\Project 1 MLR with Covariates\\jackknife cheet sheet.png")
```
...
```{r, echo = FALSE}
knitr::include_graphics("C:\\Users\\sviea\\Documents\\Advanced Data Analysis\\Project 1 MLR with Covariates\\leverage.png")
```
...
fix source hyperlink :(

```{r}
# Generate a publication level output of the model

# I could plot the CIs maybe to visualize the results??
sjPlot::plot_model(model_attach1, type = "est", show.values = TRUE, show.p = TRUE)
```
