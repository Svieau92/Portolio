...
#
# Would be really neat to consolidate some of the overview plots in dashboard and add queries and forms
#
# It would be REAAAAALLY cool to adapt the AEs rate by Sites plot into AEs rate by ARM!!!!!!!!
#       Would enable you to keep the rest of the functionality of the visual, but quickly see if any arm is experiencing
#       drastically more AEs than the other conditions/doses
################################
