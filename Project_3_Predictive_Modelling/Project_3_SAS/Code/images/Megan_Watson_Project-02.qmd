...
data_sub <- data_ex |> 
  select(-`PROBLEM LIST DX CODES`, -`PROBLEM LIST DX NAMES`, -DISCH_DISP, -`DEPT BEFORE Unit`, -`DEPT AFTER Unit`, -`CONSULT TO TREAT`, -`ADMIT TO TREAT`)
...
data_for_matrix <- data_sub |> 
  select(-Age_Range, -Admit_MonthYear, -Age_Quartile, -MV_Total_log, -MV_Total_sqrt, - Unit_LOS_log, - Unit_LOS_boxcox) |> 
